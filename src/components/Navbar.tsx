            ...
            <div className="hidden md:flex items-center space-x-6">
              <SignedIn>
                ...
                <>
                  <button
                    ...
                    className="font-aileron text-gray-700 hover:text-[#3C493F] transition-all duration-300 relative px-4 py-2 rounded-full group cursor-pointer hover:outline hover:outline-1 hover:outline-[#7E8D85]"
                  >
              ...
              <SignedOut>
                ...
                <>
                  <button
                    onClick={() => scrollToSection("objednat")}
                    className="font-aileron text-gray-700 hover:text-[#3C493F] transition-all duration-300 relative px-3 py-2 rounded-full group cursor-pointer border border-transparent hover:border-[#3C493F]"
                  >
                    <span className="relative z-10">Objednat</span>
                  </button>
                  <button
                  ...
                  <SignInButton mode="modal">
                    <button className="font-aileron text-gray-700 hover:text-[#3C493F] transition-all duration-300 relative px-3 py-2 rounded-full group cursor-pointer border border-transparent hover:border-[#3C493F]">
                      <span className="relative z-10">Přihlásit se</span>
                    </button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <button className="font-aileron bg-[#3C493F] text-white px-6 py-2 rounded-full hover:bg-[#3C493F] transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 cursor-pointer relative overflow-hidden group">
              ...
              <div className="px-2 pt-2 pb-3 space-y-2">
                <SignedIn>
                  ...
                  <>
                    <button
                      onClick={() => handleViewChange("dashboard")}
                      className="font-aileron block w-full text-left px-4 py-3 text-gray-700 bg-white/50 border border-[#e5ebe9] rounded-full hover:bg-[#3C493F]/20 hover:border-[#7E8D85] transition-all duration-300 active:scale-95 cursor-pointer"
                    >
                      Moje objednávky
                    </button>
                    {isAdmin && (
                ...
                <SignedOut>
                  ...
                  <>
                    ...
                    <SignInButton mode="modal">
                      <button className="font-aileron block w-full text-left px-4 py-3 text-gray-700 bg-white/50 border border-[#e5ebe9] rounded-full hover:bg-[#3C493F]/20 hover:border-[#7E8D85] transition-all duration-300 active:scale-95 cursor-pointer">
                        Přihlásit se
                      </button>
                    </SignInButton>
                    <SignUpButton mode="modal">
                      <button className="font-aileron block w-full px-4 py-3 bg-[#3C493F] text-white border border-[#3C493F] rounded-full hover:bg-[#3C493F] hover:border-[#3C493F] transition-all duration-300 active:scale-95 font-semibold cursor-pointer relative overflow-hidden group">
